...
\section{Projects}
    ...
    \explanationdetail{
      ...
      \hspace*{1em}\textbullet\ 고객사와 직접 소통하며 요구사항 정의, Role/Authorization, 서버 녹화, 학생 권한 제어 등 강의 특화 기능 및 관련 UI/UX 개발\par
      \hspace*{1em}\textbullet\ OWASP ZAP 기반 정기 취약점 점검 및 CSP/JWT 적용 등 보안 강화, 타 사의 웹 콘텐츠 유출 방지 솔루션 연동\par
